 ...
 */
public class SampleJettyApp {

  private final int upstreamPort;
  private final int downstreamPort;

  public SampleJettyApp(int upstreamPort, int downstreamPort) {
    this.upstreamPort = upstreamPort;
    this.downstreamPort = downstreamPort;
  }

  public static void main(String[] args) throws Exception {
    SampleJettyApp sampleJettyApp = new SampleJettyApp(50071, 50072);
    if (args.length > 1) {
      sampleJettyApp = new SampleJettyApp(Integer.parseInt(args[0]), Integer.parseInt(args[1]));
    }
    ...
    sampleJettyApp.runFullApp(clientTypes);
  }
